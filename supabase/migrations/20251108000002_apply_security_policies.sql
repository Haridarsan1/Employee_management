-- Apply stricter security policies (run after enum value is committed)
-- Migration: 20251108000003_apply_security_policies.sql
...
-- Add data integrity constraints (skip for now due to existing data conflicts)
